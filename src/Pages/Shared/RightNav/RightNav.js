...
import { FaFacebook, FaGithub, FaTwitter, FaTwitch, FaGoogle, FaCreditCard, FaWallet } from "react-icons/fa";
    ...
    return (
        <div className='App'> 
            ...
            <div id='RightNav'>
                <h3>Find us With</h3>
                <ListGroup className='gap-3'>
                    <ListGroup.Item action variant='success'><a className='text-decoration-none text-success' href="#" target='_blank'><FaCreditCard /> Payment</a></ListGroup.Item>
                    <ListGroup.Item action variant='primary'><FaFacebook /> Facebook</ListGroup.Item> 
                    <ListGroup.Item action variant='danger'><a className='text-decoration-none text-danger' href="#" target='_blank'><FaWallet/> Stipend</a></ListGroup.Item>
